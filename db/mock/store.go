...
// Source: github.com/mauzec/simple-bank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) AddBalanceAccount(ctx context.Context, arg db.AddBalanceAccountParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddBalanceAccount", ctx, arg)
...
func (mr *MockStoreMockRecorder) AddBalanceAccount(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddBalanceAccount", reflect.TypeOf((*MockStore)(nil).AddBalanceAccount), ctx, arg)
}
